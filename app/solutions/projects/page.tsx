...
function ProjectVideo({ src, title, className = "" }: { src: string; title: string; className?: string }) {
  ...
  if (hasError) {
    return (
      <div className={`bg-gray-900 rounded-2xl flex items-center justify-center ${className}`}>
